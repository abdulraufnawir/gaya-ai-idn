...
const {
  ...
  const handleGenerateModel = async () => {
    ...
    try {
      ...
      const genPredictionId = genResponse?.prediction_id || genResponse?.id;
      if (!genPredictionId) {
        console.error('No prediction ID returned:', genResponse);
        throw new Error('No prediction ID returned from KIE AI');
      }
      toast({
        title: 'Berhasil!',
...
settings: {
      ...
      const swapPredictionId = kieResponse?.prediction_id || kieResponse?.id;
      if (!swapPredictionId) {
      ...
      toast({
        title: 'Berhasil!',
        description: 'Model swap sedang diproses dengan KIE AI. Silakan cek riwayat proyek untuk melihat hasilnya.'
      });
  ...
  return <div className="bg-background p-2 sm:p-4">
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea id="generate-prompt" placeholder="Example: Full-body, brown hair, hands on hips" value={generatePrompt} onChange={e => setGeneratePrompt(e.target.value)} className="min-h-[80px]" />
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <Card className="border-2 border-dashed border-muted-foreground/20">
                <CardContent className="p-4">
                  {referenceImagePreview ? <div className="relative">
                      <img src={referenceImagePreview} alt="Reference" className="w-full h-24 object-cover rounded" />
                    ...
                    </div> : <label htmlFor="reference-upload" className="flex flex-col items-center gap-2 cursor-pointer">
        ...
        <Card>
          ...
          <CardContent>
            <ModelGallery onModelSelect={handleModelSelect} selectedModel={selectedModel} />
          </CardContent>
        </Card>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-4 h-48">
                    {originalImagePreview ? <div className="relative h-full">
                        <img src={originalImagePreview} alt="Original" className="w-full h-full object-contain rounded" />
                        <Button type="button" variant="destructive" size="sm" className="absolute top-1 right-1" onClick={() => {
                    setOriginalImage(null);
                    setOriginalImagePreview(null);
                  }}>
                      ...
                      </div> : <label htmlFor="original-upload" className="w-full h-full flex flex-col items-center justify-center cursor-pointer hover:bg-muted/10 transition-colors">
...
{/* Clothing Type Selection for Swap */}
              ...
              {/* Process Button */}
              <Button onClick={handleProcess} disabled={processing || !originalImage || !selectedModel} className="w-full" size="lg">
                {processing ? <>
                    <Loader2 className="w-4 h-4 animate-spin mr-2" />
