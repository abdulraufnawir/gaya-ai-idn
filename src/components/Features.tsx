        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-secondary p-8 rounded-2xl border border-border shadow-soft">
            ...
            <p className="text-muted-foreground mb-6 max-w-lg mx-auto">
              Bergabung dengan 500+ brand Indonesia yang sudah merasakan peningkatan konversi hingga 40%
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="border border-border text-foreground px-6 py-3 rounded-xl font-semibold hover:bg-accent transition-all duration-300">
                Konsultasi Gratis
              </button>
            </div>
          </div>
